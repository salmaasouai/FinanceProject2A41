  ...
  <main id="main" class="main">
   <!--Page Title (body) -->
    ...
    <div class="row mb-3">
        ...
        <div class="col-sm-10">
            <input type="text" class="form-control" maxlength="25" placeholder="Place event id" name="IdEv" id="IdEv">
            <span id="error2"></span>
        </div>
    </div>
  ...
  <script>
    ...
    myform.addEventListener('submit', function(e) {
        ...
        if (myinput.value.trim() === '') {
            ...
            myerror.innerHTML = "Le champ nom doit être rempli";
        ...
        if (myinput2.value.trim() === '') {
            ...
            myerror2.innerHTML = "Le champ date doit être rempli";
