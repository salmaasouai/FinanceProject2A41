...
$tab = $sponsorController->afficherSponsor(); // Assurez-vous que cette méthode récupère correctement les données des sponsors depuis la base de données
...
<li class="nav-item">
 ...
 <li class="nav-item">
  ...
  <main id="main" class="main">
    <!-- Votre code HTML pour le contenu de la page -->
          ...
          <div class="card">
            <div class="card-body">
              ...
              <table class="table datatable">
                ...
                <tbody>
    <?php foreach ($filteredData as $sponsor): ?>
        <tr>
            <td><?= $sponsor['idSponsor']; ?></td>
            <td><?= $sponsor['NomSpon']; ?></td>
            <td><?= $sponsor['nom_event']; ?></td>
            <td>
                <!-- Affichage de l'image -->
                <img src="events_pics/<?= $sponsor['ImgSpon']; ?>" alt="Sponsor Image" width="100" height="100">
            </td>
            <td>
                <a href="deleteS.php?id=<?= $sponsor['idSponsor']; ?>" class="btn btn-danger">Delete</a>
                <a href="updateS.php?id=<?= $sponsor['idSponsor']; ?>" class="btn btn-primary">Update</a>
            </td>
        </tr>
    <?php endforeach; ?>
</tbody>
              ...
              <div class="text-center">
                <a href="pdfSpon.php" class="btn btn-primary">Generate PDF</a>
